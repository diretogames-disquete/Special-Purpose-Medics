...
(function () {
  ...
  var accent = null;         // optional explicit accent [r,g,b] (overrides condition)
  ...
  function recomputeTargets() {
    ...
    var base = accent ? accent : CONDITION[themeName()][level];
    targetC1 = base.slice();
  ...
  // Explicit accent colour [r,g,b] in 0..1 (overrides the condition palette);
  // pass null to fall back to condition tinting.
