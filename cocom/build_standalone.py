#!/usr/bin/env python3
"""Build a self-contained, offline single-file SPM COCOM Scenarios dashboard.

Inlines styles.css, webgl.css, webgl-background.js and app.js into index.html.
(The Google webfont link is kept; offline it falls back to the system
serif/sans/mono stack declared in the CSS.)

Usage:  python3 build_standalone.py   ->  SPM_COCOM_Scenarios_Standalone.html
"""
import os

HERE = os.path.dirname(os.path.abspath(__file__))
OUT = os.path.join(HERE, "SPM_COCOM_Scenarios_Standalone.html")
